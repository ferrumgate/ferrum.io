...
SRC = src
TEST = test
OBJS = ./common/rebrick_util.o ./common/rebrick_log.o ./common/rebrick_resolve.o ./common/rebrick_timer.o ./socket/rebrick_udpsocket.o ./socket/rebrick_tcpsocket.o ./common/rebrick_tls.o \
...
OBJSTEST = test.o ./server_client/udpecho.o ./server_client/tcpecho.o test_rebrick_util.o test_rebrick_resolve.o \
			...
			test_rebrick_filestream.o \
			../src/common/rebrick_util.o ../src/common/rebrick_log.o  ../src/common/rebrick_resolve.o ../src/common/rebrick_timer.o  \

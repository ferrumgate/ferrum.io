...
OBJS = main_rebrick.o rebrick_util.o rebrick_config.o rebrick_async_udpsocket.o rebrick_async_tcpsocket.o rebrick_tls.o rebrick_async_tlssocket.o rebrick_async_httpsocket.o \
 		rebrick_context.o rebrick_metrics.o rebrick_buffers.o ./lib/b64/decode.o ./lib/b64/encode.o ./lib/picohttpparser.o   \
...
OBJSTEST = test.o ./server_client/udpecho.o ./server_client/tcpecho.o test_rebrick_util.o \
			 ...
			 test_rebrick_tls.o \
			test_rebrick_async_udpsocket.o test_rebrick_async_tcpsocket.o test_rebrick_async_tlssocket.o  test_rebrick_buffer.o test_rebrick_buffers.o \

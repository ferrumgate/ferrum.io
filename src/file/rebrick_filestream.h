...
typedef void (*rebrick_filestream_on_read_callback_t)(struct rebrick_filestream *stream,void *callback_data,size_t size);
typedef void (*rebrick_filestream_on_write_callback_t)(struct rebrick_filestream *stream,void *callback_data,size_t size);
...
public_ typedef struct rebrick_filestream{
    ...
    public_ readonly_ rebrick_filestream_callbacks_t *callbacks;

}rebrick_filestream_t;

#define cast_to_filestream(x)  cast(x,rebrick_filestream_t*)

int32_t rebrick_filestream_new(rebrick_filestream_t **stream,const char *path,int32_t flag,int32_t mode,rebrick_filestream_callbacks_t *callbacks);

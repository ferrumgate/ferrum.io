...
uint8_t REBRICK_HTTP2_ALPN_PROTO[4]; // uint8_t REBRICK_HTTP2_ALPN_PROTO[4]={2,'h','2',0};
#define REBRIKC_HTTP2_ALPN_PROTO_LEN 3

uint8_t REBRICK_HTTP_ALPN_PROTO[10];
#define REBRIKC_HTTP_ALPN_PROTO_LEN 9

uint8_t REBRICK_HTTP_HTTP2_ALPN_PROTO[13];

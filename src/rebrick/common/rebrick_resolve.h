...
typedef void (*on_resolve_callback_t)(const char *domain, int32_t type, rebrick_sockaddr_t addr, void *data);
typedef void (*on_resolve_error_callback_t)(const char *domain, int32_t type, int32_t error, void *data);

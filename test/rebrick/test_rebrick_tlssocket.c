...
#include "./rebrick/socket/rebrick_tlssocket.h"
#include "cmocka.h"
#include <unistd.h>
#include <string.h>
...
static int setup(void **state) {
  ...
  rebrick_tls_context_new(&context_server, "server", SSL_VERIFY_NONE, SSL_SESS_CACHE_BOTH, SSL_OP_ALL, 0, "./rebrick/data/domain.crt", "./rebrick/data/domain.key");
  ...
  rebrick_tls_context_new(&context_servermanual, "servermanuel", SSL_VERIFY_NONE, SSL_SESS_CACHE_OFF, SSL_OP_ALL | SSL_OP_NO_SSLv2 | SSL_OP_NO_SSLv3 | SSL_OP_NO_TICKET, SSL_OP_NO_COMPRESSION, "./rebrick/data/domain.crt", "./rebrick/data/domain.key");

  rebrick_tls_context_new(&context_hamzakilic_com, "hamzakilic.com", SSL_VERIFY_NONE, SSL_SESS_CACHE_OFF, SSL_OP_ALL | SSL_OP_NO_SSLv2 | SSL_OP_NO_SSLv3 | SSL_OP_NO_TICKET, SSL_OP_NO_COMPRESSION, "./rebrick/data/domain.crt", "./rebrick/data/domain.key");
  rebrick_tls_context_new(&context_test_com, "test.com", SSL_VERIFY_NONE, SSL_SESS_CACHE_BOTH, SSL_OP_ALL, 0, "./rebrick/data/test.com.crt", "./rebrick/data/test.com.key");
...
static void ssl_client_download_data(void **start) {
  // before testing this method
  // under docker_ssl/ngix_data folder create file 100MB file with name 100m.ignore.txt
  unused(start);
  int32_t result;
